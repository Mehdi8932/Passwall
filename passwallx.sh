...
rm -f passwall.sh && wget https://raw.githubusercontent.com/Mehdi8932/Passwall/main/passwall.sh && chmod 777 passwall.sh && sh passwall.sh
...
rm -f passwall2x.sh && wget https://raw.githubusercontent.com/Mehdi8932/Passwall/main/passwall2x.sh && chmod 777 passwall2x.sh && sh passwall2x.sh
...
rm -f mahsa.sh && wget https://raw.githubusercontent.com/Mehdi8932/Passwall/refs/heads/main/mahsa.sh && chmod 777 mahsa.sh && sh mahsa.sh
